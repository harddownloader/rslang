...
const useStyles = makeStyles({
    ...
    wrapperStats: {
        backgroundImage: 'url(https://png.pngtree.com/illustrations/20190320/ourlarge/pngtree-high-tech-2-5d-technology-the-internet-png-image_22625.jpg)',
    ...
    recharts: {
        ...
        background: 'linear-gradient(90deg, rgba(12,179,232,1) 2%, rgba(38,241,211,1) 80%)',
        display: 'flex',
            ...
            <Container maxWidth="lg" className={classes.wrapper}>
                ...
                {isStats ? <Grid container className={classes.recharts} spacing={2} >
                    <Grid container item xs={3} >
                        ...
                        <Grid item lg={12} xs={12}><Button size='large' className={classes.button} >Аудио-
                        вызов</Button></Grid>
                        <Grid item lg={12} xs={12}><Button size='large' className={classes.button} >Спринт</Button></Grid>
                        <Grid item lg={12} xs={12}><Button size='large' className={classes.button} >Default</Button></Grid>
                    </Grid>
                    <Grid item xs={9}><Progress /></Grid>
                </Grid> :
                    <Grid container className={classes.recharts} >
                        <Grid item md={6} xs={12}  ><Recharts /></Grid>
